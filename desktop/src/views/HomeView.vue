  ...
  <section class="dashboard">
    ...
    <section class="dashboard-stats">
      <article class="stat-card">
        ...
        <strong class="stat-value">{{ statsLoading ? "—" : stats.articleCount }}</strong>
        <small class="stat-desc">已发布文章总数</small>
      </article>
      <article class="stat-card">
        <span class="stat-label">知识库</span>
        <strong class="stat-value">{{ statsLoading ? "—" : stats.knowledgeBaseCount }}</strong>
        <small class="stat-desc">已创建知识库数</small>
      </article>
      <article class="stat-card">
        <span class="stat-label">Agent 调用</span>
        <strong class="stat-value">{{ statsLoading ? "—" : stats.totalAgentRuns }}</strong>
        <small class="stat-desc">累计运行次数</small>
      </article>
      <article class="stat-card">
        <span class="stat-label">平均延迟</span>
        <strong class="stat-value">{{ statsLoading ? "—" : Math.round(stats.averageLatencyMs) }}<small>ms</small></strong>
        <small class="stat-desc">最近 Agent 响应</small>
      </article>
    </section>
