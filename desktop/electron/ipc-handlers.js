const { ipcMain, dialog, BrowserWindow, clipboard, Notification } = require('electron')
const fs = require('fs')
...
function setupBackendHandlers(backendUrl) {
...
function setupAllHandlers(backendUrl) {
  setupWindowHandlers()
  setupSystemHandlers()
  setupFileHandlers()
