...
import { Back, Lock, Refresh, User } from "@element-plus/icons-vue";
  ...
  <main class="shell">
    <aside class="sidebar">
      ...
      <nav class="nav">
        ...
        <RouterLink to="/observability">观测评估</RouterLink>
        <RouterLink class="active" to="/security">安全</RouterLink>
      </nav>
    </aside>

    <section class="workspace security-workspace">
      <header class="topbar">
        <div>
          <p class="eyebrow">Day 12 RBAC + Security</p>
          <h1>权限、安全与工程化</h1>
        </div>
        <RouterLink to="/">
